...
void taskRescue(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of rescue */
  osThreadDef(rescue, taskRescue, osPriorityRealtime, 0, 512);
  rescueHandle = osThreadCreate(osThread(rescue), NULL);
...
/* USER CODE BEGIN Header_taskRescue */
/**
* @brief Function implementing the rescue thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_taskRescue */
void taskRescue(void const * argument)
{
  /* USER CODE BEGIN taskRescue */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END taskRescue */
}
