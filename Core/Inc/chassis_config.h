...
/* 速度环 */
float Chassis_Speed_Kp   = 11.3f; /*< 速度环P参数 */
float Chassis_Speed_Ki   = 0.53f; /*< 速度环I参数 */
float Chassis_Speed_Kd   = 0.0f; /*< 速度环D参数 */ //0.03
float Chassis_Speed_Inc_Limit = 16000.0f; /*< 速度环增量限幅 */

/* 电流环 */
float Chassis_Current_Kp = 1.70f; /*< 电流环P参数 */
float Chassis_Current_Ki = 0.34f; /*< 速度环I参数 */
float Chassis_Current_Kd = 0.0f; /*< 速度环D参数 */  //0.03
